...
template<> SIOJEDITORPLUGIN_API UScriptStruct* StaticStruct<FSIOJ_NamedType>()
{
	...
	struct Z_CompiledInDeferFile_FID_UDP_Communications_5_2_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UDP_Communications_5_2_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UDP_Communications_5_2_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UDP_Communications_5_2_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UDP_Communications_5_2_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_4013059390(TEXT("/Script/SIOJEditorPlugin"),
		Z_CompiledInDeferFile_FID_UDP_Communications_5_2_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UDP_Communications_5_2_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UDP_Communications_5_2_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UDP_Communications_5_2_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_UDP_Communications_5_2_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UDP_Communications_5_2_Plugins_SocketIOClient_Source_SIOJEditorPlugin_Public_SIOJ_BreakJson_h_Statics::EnumInfo));
